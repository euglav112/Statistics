...
public class PlugDataSource implements Dao {
    ...
    @Override
    public int getColumn5(int id) { return (int) dataMap.get(id).getColumn(5); }

    @Override
    public int getColumn6(int id) {
        return (int) dataMap.get(id).getColumn(6);
    }

    @Override
    public int getColumn7(int id) {
        return (int) dataMap.get(id).getColumn(7);
    }

    @Override
    public int getColumn8(int id) { return (int) dataMap.get(id).getColumn(8); }
